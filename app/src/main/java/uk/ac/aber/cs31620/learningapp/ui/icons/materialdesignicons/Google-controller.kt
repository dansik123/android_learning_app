package uk.ac.aber.cs31620.learningapp.ui.icons.materialdesignicons
...
/*
* This Icon I took from webpage https://petershaggynoble.github.io/MDI-Sandbox/
* Phrase which i search for was "Google-controller"
*/
public val materialDesignIcons.googleController: ImageVector
    get() {
        if (`_google-controller` != null) {
            return `_google-controller`!!
        }
        `_google-controller` = Builder(name = "Google-controller", defaultWidth = 24.0.dp,
...
private var `_google-controller`: ImageVector? = null
